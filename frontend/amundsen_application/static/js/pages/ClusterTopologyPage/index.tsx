...
// ==============================================================================
// UPDATED VERSION with Settings Menu and Configurable API Endpoint
// ==============================================================================
...
const ENVIRONMENT_PRESETS = {
  ...
  k8s: {
    name: 'Kubernetes',
    apiBaseUrl: 'http://optimusdb-service:8089',
    apiContext: 'swarmkb',
  },
  custom: {
    name: 'Custom',
...
const ClusterTopologyPage: React.FC = () => {
  ...
  const [settings, setSettings] = useState<Settings>(() => {
    ...
    return {
      apiBaseUrl: 'http://localhost:18001', // Docker Desktop default
      apiContext: 'swarmkb',
  ...
  const fetchClusterData = useCallback(async () => {
    try {
      setLoading(true);
      const apiUrl = `${settings.apiBaseUrl}/${settings.apiContext}/agent/status`;
  ...
  // Helper function - get health class
  ...
  const handlePresetSelection = (preset: keyof typeof ENVIRONMENT_PRESETS) => {
    const presetSettings = ENVIRONMENT_PRESETS[preset];
    return {
      apiBaseUrl: presetSettings.apiBaseUrl,
      apiContext: presetSettings.apiContext,
      ...
      <div className="cluster-topology-page">
        ...
        <div className="error-container">
          ...
          <div className="error-help">
            ...
            <ul>
              <li>Current API URL: <code>{settings.apiBaseUrl}/{settings.apiContext}/agent/status</code></li>
              <li>Check OptimusDB is running</li>
              <li>Verify the API endpoint URL in Settings</li>
              <li>Check for CORS issues in browser console (F12)</li>
            </ul>
            <div className="quick-test">
              <strong>Quick Test:</strong>
              <pre>curl {settings.apiBaseUrl}/{settings.apiContext}/agent/status</pre>
            </div>
          </div>
        </div>
    ...
    <div className="cluster-topology-page">
      ...
      <div className="resource-header">
        ...
        <div className="header-subtitle">
          ...
          <span className="api-endpoint">API: {settings.apiBaseUrl}</span>
        </div>
      </div>
        ...
        <>
          ...
          <div className="election-section">
            ...
            <div className="election-info">
              ...
              <div className="election-card">
                <div className="label">Your Health Score</div>
                <div className="value">
                  {clusterData.agent.health.score} ({clusterData.agent.health.status})
                </div>
              </div>
              <div className="election-card">
...
interface SettingsModalProps {
  ...
  onClose: () => void;
  onPresetSelect: (preset: keyof typeof ENVIRONMENT_PRESETS) => Settings;
}

const SettingsModal: React.FC<SettingsModalProps> = ({ settings, onSave, onClose, onPresetSelect }) => {
  const [localSettings, setLocalSettings] = useState<Settings>(settings);
  const [selectedPreset, setSelectedPreset] = useState<string>('custom');

  const handlePresetChange = (preset: keyof typeof ENVIRONMENT_PRESETS) => {
    setSelectedPreset(preset);
    if (preset !== 'custom') {
      const presetSettings = onPresetSelect(preset);
  ...
  const handleTest = async () => {
    try {
      const apiUrl = `${localSettings.apiBaseUrl}/${localSettings.apiContext}/agent/status`;
      const response = await fetch(apiUrl);
      if (response.ok) {
        ...
        <div className="modal-body">
          ...
          <div className="form-group">
            ...
            <select
              ...
              onChange={(e) => handlePresetChange(e.target.value as keyof typeof ENVIRONMENT_PRESETS)}
            >
              <option value="docker">🐳 Docker Desktop (localhost:18001)</option>
              <option value="k3s">🚀 k3s (localhost:8089)</option>
              <option value="k8s">☸️ Kubernetes (optimusdb-service:8089)</option>
              <option value="custom">🔧 Custom</option>
            </select>
            <small className="form-text">Select your deployment environment</small>
          </div>
          ...
          <div className="form-group">
            ...
            />
            <small className="form-text">OptimusDB API server URL</small>
          </div>
          ...
          <div className="endpoint-preview">
            ...
            <code>{localSettings.apiBaseUrl}/{localSettings.apiContext}/agent/status</code>
          </div>
        </div>
...
// ==============================================================================
// ==============================================================================
// Topology Canvas Sub-Component - FULL INTERACTIVE VERSION
