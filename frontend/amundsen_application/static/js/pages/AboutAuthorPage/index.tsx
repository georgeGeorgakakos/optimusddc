...
const PUBLICATIONS = [
  {
    title:
      'OptimusDB: A Decentralised Knowledge Base for the Swarmchestrate Ecosystem',
    venue: 'CENTERIS 2025',
    year: '2025',
    type: 'Conference',
    color: 'pub-purple',
  ...
  {
    title:
      'Decentralized Data Catalog for Renewable Energy Metadata Management',
    venue: 'AINA 2025',
    year: '2025',
    type: 'Conference',
    color: 'pub-blue',
  ...
  {
    title: 'Swarm-based Knowledge Management in Cognitive Computing Continuum',
      ...
      <div className="author-hero-content">
        ...
        <div className="author-hero-text">
          ...
          <p className="author-title">
            Associate Researcher · ICCS / IMU — NTUA
          </p>
          <p className="author-subtitle">
            contact: george.georgakakos@gmail.com / ggeorgakakos@aueb.gr
          </p>
    ...
    <div className="author-body">
      ...
      <section className="author-section">
        ...
        <div className="author-bio-card">
          <p>
            George Georgakakos is a technology professional and researcher
            combining enterprise consulting with academic research in
            distributed systems.
          </p>
          <p>
            His research is embedded in the EU Horizon Europe{' '}
            <strong>Swarmchestrate project</strong> (Grant No. 101135012), for
            which he is building <em>OptimusDB</em> and <em>OptimusDDC</em> — a
            decentralised knowledge base engine and data catalog frontend for
            the Swarmchestrate ecosystem.
          </p>
        </div>
      </section>
        ...
        <div className="author-projects">
          <a className="author-project-card" href="/about/optimus">
            ...
            <div>
              ...
              <div className="author-project-desc">
                Decentralised knowledge base engine — Go, LibP2P, OrbitDB, Raft
                consensus, TinyLlama
              </div>
            </div>
          </a>
          <a className="author-project-card" href="/about/optimus">
            ...
            <div>
              ...
              <div className="author-project-desc">
                Decentralised data catalog frontend — Amundsen fork,
                React/TypeScript, five dashboards, AI assistant
              </div>
            </div>
          </a>
        </div>
