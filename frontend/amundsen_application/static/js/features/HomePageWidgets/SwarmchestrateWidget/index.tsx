...
// ⚙️ RUNTIME AGENT DETECTION
// The widget will automatically detect the number of running agents by:
// 1. Trying to connect to agents on ports 18001-18020
// 2. Counting which ones respond successfully
...
// ==============================================================================
// RUNTIME AGENT DETECTION FROM API
// ==============================================================================

/**
 * Detects how many agents are running by querying the agent status endpoint
 * Uses cluster.total_peers from the API response
 *
 ...
 * }
 *
 * For mock data mode (agent not available): Falls back to 8 agents
 */
...
const SwarmchestrateWidget: React.FC = () => {
  ...
  React.useEffect(() => {
    ...
    // Re-detect every 5 minutes (agents may scale up/down)
    const detectionInterval = setInterval(detectAgents, 5 * 60 * 1000); // 5 minutes
