...
optimus = ['requests>=2.0.0']

all_deps = requirements + requirements_common + requirements_dev + oidc + atlas + rds + gremlin + optimus

setup(
    name='amundsen-metadata',
    version=__version__,
    description='Metadata service for ddC',
    ...
    zip_safe=False,
    install_requires=requirements + requirements_common + ['requests>=2.0.0'],
    extras_require={
        'all': all_deps,
