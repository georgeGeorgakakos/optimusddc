...
```bash
$ git clone --recursive git@github.com:optimusddc-io/optimusddc.git
```
...
```bash
Step 3/20 : RUN git clone --recursive git://github.com/optimusddc-io/amundsenfrontendlibrary.git  && cd amundsenfrontendlibrary  && git submodule foreach git pull origin master
 ---> Using cache
 ---> ec052612747e
```
...
```yaml
  amundsenfrontend:
      #image: amundsendev/optimusddc-frontend:1.0.9
      #image: 1234.dkr.ecr.us-west-2.amazonaws.com/edmunds/optimusddc-frontend:2020-01-21
      image: 0312d0ac3938
```
