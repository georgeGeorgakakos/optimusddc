...
class Config:
    ...
    # ✅ CRITICAL FIX: Create the OPTIMUSDB config key that proxy/__init__.py expects
    # This line is THE FIX for the KeyError: 'OPTIMUSDB'
    OPTIMUSDB = ES_PROXY_CLIENT
...
class LocalConfig(Config):
    ...
    #                                )
    #ES_PROXY_CLIENT = PROXY_CLIENTS[os.environ.get('ES_PROXY_CLIENT', 'ELASTICSEARCH_V2_1')]
    # ✅ FIXED: OptimusDB endpoint instead of Elasticsearch
    PROXY_ENDPOINT = os.environ.get('PROXY_ENDPOINT',
                                    os.environ.get('OPTIMUSDB_API_URL', 'http://localhost:8089'))
    # ✅ FIXED: Use OptimusDB by default
    ES_PROXY_CLIENT = PROXY_CLIENTS[os.environ.get('ES_PROXY_CLIENT', 'OPTIMUSDB')]
